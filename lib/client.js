...
function useReveal(open, when, opts) {
  ...
  const prev = (0, import_react.useRef)({ open, when });
...
function ConfigCard(props) {
  ...
  const [autoReveal, setAutoReveal] = (0, import_react2.useState)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { ref: shellRef, className: "psi-shell" + (open ? " psi-shellOpen" : ""), children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "psi-shellHeadText", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "psi-shellName", children: title }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "psi-shellDesc", children: description })
          ] }),
          dirty && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "psi-shellPending", children: t("unsaved") }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconChevronDownOutline14, { className: "psi-shellChevron" + (open ? " psi-shellChevronOpen" : "") })
        ]
      }
    ),
    open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "psi-shellBody", children: [
      children,
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "psi-shellFooter", children: [
        failed !== "" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "psi-shellFailed", role: "status", children: failed }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "psi-shellDiscard", disabled: !dirty || saving, onClick: onDiscard, children: t("discard") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "psi-shellSave", disabled: !dirty || saving || invalid, onClick: onSave, children: saving ? "\u2026" : t("save") })
      ] })
    ] })
  ] });
}
...
`;
injectStyle("@deepseek-ai/dsh-message-injector/PresetSelector.module.css", CSS2);
...
var pendingCardExpand = false;
var cardExpandListeners = /* @__PURE__ */ new Set();
function requestCardExpand() {
  pendingCardExpand = true;
  for (const fn of cardExpandListeners) fn();
}
function consumeCardExpand() {
  if (!pendingCardExpand) return false;
  pendingCardExpand = false;
  return true;
}
function subscribeCardExpand(fn) {
  cardExpandListeners.add(fn);
  return () => {
    cardExpandListeners.delete(fn);
  };
}
var cardExpandSignal = {
...
async function openSettingsAndExpand() {
  ...
  for (let attempt = 0; attempt < 15; attempt++) {
    ...
    if (!nav) return;
    const target = Array.from(nav.querySelectorAll("button")).find((b) => /插件|Plugins/.test(b.textContent ?? ""));
    if (!target) return;
...
function PresetSelector({ scope, t: tRaw }) {
  const t = tRaw ?? ((k) => k);
  const snap = (0, import_react3.useSyncExternalStore)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    import_dsh_client_ui_primitives2.Menu,
    {
      ...
      side: "top",
      footer: [{ id: "__settings__", label: t("openSettings"), icon: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives2.IconSettingsOutline16, {}) }],
      anchor: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
        "button",
        {
          ...
          onClick: () => setOpen(!open),
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives2.IconSkillOutline16, {}),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: current ? current.name : t("preset") }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives2.IconChevronDownOutline14, { className: "psi-chevron" + (open ? " psi-chevron-open" : "") })
          ]
        }
      )
    }
...
function PresetConfigCard({ scope, fetchKnownSkillNames: fetchKnownSkillNames2, t: tRaw }) {
  ...
  const [draft, setDraft] = (0, import_react3.useState)(() => (snap.status === "ready" ? snap.value?.groups ?? [] : []).map(cloneGroup));
  const [dirty, setDirty] = (0, import_react3.useState)(false);
  const [knownSkills, setKnownSkills] = (0, import_react3.useState)(null);
  const [saving, setSaving] = (0, import_react3.useState)(false);
  const [failed, setFailed] = (0, import_react3.useState)("");
  const [openMap, setOpenMap] = (0, import_react3.useState)({});
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
    ConfigCard,
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "psi-field psi-addRow", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { type: "button", className: "psi-add", onClick: addGroup, children: [
          "+ ",
          t("addGroup")
        ] }) }),
        draft.map((g, i) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "psi-group", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "psi-groupHead", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "psi-groupName" + (g.name.trim() === "" ? " psi-groupNameEmpty" : ""), children: g.name.trim() || t("groupName") }),
                    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives2.IconChevronDownOutline14, { className: "psi-groupChevron" + (isOpen ? " psi-groupChevronOpen" : "") })
                  ]
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { className: "psi-checkLabel", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "psi-iconBtn", title: t("moveUp"), disabled: i === 0, onClick: () => move(i, -1), children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives2.IconChevronUpOutline14, {}) }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "psi-iconBtn", title: t("moveDown"), disabled: i === draft.length - 1, onClick: () => move(i, 1), children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives2.IconChevronDownOutline14, {}) }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "psi-iconBtn", title: t("remove"), onClick: () => removeGroup(i), children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives2.IconTrashOutline16, {}) })
            ] }),
            isOpen && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "psi-groupBody", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "psi-groupField", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "psi-head", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "psi-label", children: t("groupName") }) }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                  "input",
                  {
                ...
                nErr !== "" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "psi-invalid", children: nErr })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "psi-groupField", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "psi-head", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "psi-label", children: t("description") }) }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                  "input",
                  {
                    className: "psi-input",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "psi-groupField", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "psi-head", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "psi-label", children: t("content") }) }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                  "textarea",
                  {
                ...
                cErr !== "" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "psi-invalid", children: cErr }),
                missing.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { className: "psi-warn", children: [
                  t("missingSkills"),
                  missing.join(", ")
                ] })
              ] })
